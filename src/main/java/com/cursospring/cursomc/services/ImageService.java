...
public class ImageService {
    ...
    public BufferedImage getJpgImageFromFile(MultipartFile uploadedFile) throws FileException {
    ...
    public InputStream getInputStream(BufferedImage img, String extension) throws FileException {
        try {
